<?php 
    ...
    error_reporting(E_ERROR | E_PARSE);
        ...
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and currentday not IN ('sat','sun')  "));
        ...
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and currentday IN ('sat','sun')  "));
        $otcwin=$values['total'];
        ...
        // sun
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and pair='EURUSD-OTC' and currentday='Sun' "));
        ...
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and pair='GBPUSD-OTC' and currentday='Sun' "));
        ...
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and pair='USDCHF-OTC' and currentday='Sun' "));
        ...
        $values=mysqli_fetch_assoc(mysqli_query($conn,"SELECT count(*) as total FROM parisdetail where result='win' and pair='NZDUSD-OTC' and currentday='Sun' "));
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
          ...
          <span class="parent-font"><?php echo $weekwin; ?></span>
       
       
          <span class="child-font margin-right-class">week Loss:</span>
          <span class="parent-font"><?php echo $weekloss; ?></span>
       
      </div>
      <div class="row">
       
          <span class="child-font ">OTC Win:</span>
          <span class="parent-font"><?php echo $otcwin; ?></span>
       
       
          <span class="child-font margin-right-class">OTC Loss:</span>
          <span class="parent-font"><?php echo $otcloss; ?></span>
      ...
      <table class="table ">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span class='parent-font'><?php echo $sunusdchfotcwin .'-'.$sunusdchfotcloss; ?></span>
              <span class="child-font"> <?php echo round($sunusdchfotcwin/ ($sunusdchfotcwin+$sunusdchfotcloss)*100).'-'.round($sunusdchfotcloss/ ($sunusdchfotcwin+$sunusdchfotcloss)*100); ?></span>
              <span class="percentageclass">%</span>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <span class='parent-font'><?php echo $sunnzdusdotcwin .'-'.$sunnzdusdotcloss; ?></span>
              <span class="child-font"> <?php echo round($sunnzdusdotcwin/ ($sunnzdusdotcwin+$sunnzdusdotcloss)*100).'-'.round($sunnzdusdotcloss/ ($sunnzdusdotcwin+$sunnzdusdotcloss)*100); ?></span>
              <span class="percentageclass">%</span>
            </td>
          </tr>
        </tbody>
